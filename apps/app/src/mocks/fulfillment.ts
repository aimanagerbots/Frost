...
const orders: FulfillmentOrder[] = [
  ...
  {
    id: 'ful-005',
    orderId: 'ord-2026-0345',
    orderNumber: 'ORD-2026-0345',
  ...
  {
    id: 'ful-006',
    orderId: 'ord-2026-0336',
    orderNumber: 'ORD-2026-0336',
    ...
    startedAt: '2026-03-07T08:10:00Z',
  },
  {
    id: 'ful-007',
    orderId: 'ord-2026-0337',
    orderNumber: 'ORD-2026-0337',
    ...
    startedAt: '2026-03-07T08:20:00Z',
  },
  {
    id: 'ful-008',
    orderId: 'ord-2026-0338',
    orderNumber: 'ORD-2026-0338',
  ...
  {
    id: 'ful-009',
    orderId: 'ord-2026-0339',
    orderNumber: 'ORD-2026-0339',
  ...
  {
    id: 'ful-010',
    orderId: 'ord-2026-0330',
    orderNumber: 'ORD-2026-0330',
  ...
  {
    id: 'ful-011',
    orderId: 'ord-2026-0331',
    orderNumber: 'ORD-2026-0331',
  ...
  {
    id: 'ful-012',
    orderId: 'ord-2026-0332',
    orderNumber: 'ORD-2026-0332',
    ...
    estimatedMinutes: 16,
    actualMinutes: 14,
    createdAt: '2026-03-07T06:15:00Z',
  ...
  {
    id: 'ful-013',
    orderId: 'ord-2026-0325',
    orderNumber: 'ORD-2026-0325',
  ...
  {
    id: 'ful-014',
    orderId: 'ord-2026-0326',
    orderNumber: 'ORD-2026-0326',
  ...
  {
    id: 'ful-015',
    orderId: 'ord-2026-0320',
    orderNumber: 'ORD-2026-0320',
    ...
    startedAt: '2026-03-07T04:00:00Z',
  },
  {
    id: 'ful-016',
    orderId: 'ord-2026-0321',
    orderNumber: 'ORD-2026-0321',
    ...
    startedAt: '2026-03-07T04:30:00Z',
  },
  ...
  // MANIFESTED / READY-FOR-DRIVER (2)
  {
    ...
    estimatedMinutes: 24,
    actualMinutes: 22,
    manifestNumber: 'MAN-2026-0307-001',
    createdAt: '2026-03-07T02:00:00Z',
    startedAt: '2026-03-07T03:00:00Z',
    completedAt: '2026-03-07T06:30:00Z',
  },
  {
    id: 'ful-018',
    orderId: 'ord-2026-0316',
    orderNumber: 'ORD-2026-0316',
    accountName: 'Capitol Hill Collective',
    ...
    estimatedMinutes: 30,
    actualMinutes: 26,
    manifestNumber: 'MAN-2026-0307-002',
    createdAt: '2026-03-07T01:30:00Z',
    startedAt: '2026-03-07T02:30:00Z',
    completedAt: '2026-03-07T06:00:00Z',
  },
];
...
export async function getFulfillmentProgress(): Promise<FulfillmentProgress> {
  await delay(300);
  return {
    stages: [
      { status: 'queued', count: 5, label: 'Queued' },
      { status: 'picking', count: 4, label: 'Picking' },
      { status: 'picked', count: 3, label: 'Picked' },
      { status: 'packing', count: 2, label: 'Packing' },
      { status: 'packed', count: 2, label: 'Packed' },
      { status: 'manifested', count: 1, label: 'Manifested' },
      { status: 'ready-for-driver', count: 1, label: 'Ready' },
    ],
    totalUnitsToday: 380,
    unitsPicked: 234,
    unitsPacked: 156,
...
export async function getPackingOperations(): Promise<PackingOperation[]> {
  await delay(300);
  return [
    {
      id: 'pack-001',
