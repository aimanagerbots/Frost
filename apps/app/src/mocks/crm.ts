...
const greenfield: Account = {
  ...
  pipelineHistory: [
    ...
    { from: { status: 'active', phase: 2 }, to: { status: 'active', phase: 3 }, date: '2025-03-01', trigger: 'Consistent ordering for 6 months, 3+ categories' },
    { from: { status: 'active', phase: 3 }, to: { status: 'active', phase: 4 }, date: '2025-09-01', trigger: 'Deep relationship, broad category mix, strong sell-through' },
    { from: { status: 'active', phase: 4 }, to: { status: 'active', phase: 5 }, date: '2026-01-15', trigger: 'Full VMI enrollment, maximum share of shelf' },
  ],
  pipeline: makePipelineInfo('active', 5, '2026-01-15', 'rep-jake', 'A4', '2025-09-01', '2026-04-15', 'Top account — full VMI, strategic partner review quarterly'),
...
const pacificLeaf: Account = {
  ...
  pipelineHistory: [
    ...
    { from: { status: 'active', phase: 3 }, to: { status: 'active', phase: 4 }, date: '2026-01-20', trigger: 'Deep relationship, broad product mix' },
  ],
  pipeline: makePipelineInfo('active', 4, '2026-01-20', 'rep-priya', 'A3', '2025-07-15', '2026-04-20', 'POS migration may affect ordering cadence temporarily'),
...
const emeraldCity: Account = {
  ...
  pipelineHistory: [
    ...
    { from: { status: 'active', phase: 3 }, to: { status: 'active', phase: 4 }, date: '2025-10-15', trigger: 'Broad mix, strong sell-through, VMI enrolled' },
    { from: { status: 'active', phase: 4 }, to: { status: 'active', phase: 5 }, date: '2026-02-01', trigger: 'Full VMI, maximum share of shelf achieved' },
  ],
  pipeline: makePipelineInfo('active', 5, '2026-02-01', 'rep-jake', 'A4', '2025-10-15', '2026-05-01', 'Strategic partner — full VMI enrollment'),
  paymentReliability: 'excellent',
  preferredPaymentMethod: 'cod',
...
const cascadeWellness: Account = {
  ...
  pipelinePhase: 3,
  pipelineHistory: [
    { from: { status: 'active', phase: 1 }, to: { status: 'active', phase: 2 }, date: '2026-01-20', trigger: 'Consistent biweekly ordering established' },
    { from: { status: 'active', phase: 2 }, to: { status: 'active', phase: 3 }, date: '2026-02-28', trigger: 'Category expansion into prerolls, growing AOV' },
  ],
  pipeline: makePipelineInfo('active', 3, '2026-02-28', 'rep-carlos', 'A2', '2026-01-20', '2026-05-28'),
...
const pugetSound: Account = {
  ...
  pipeline: makePipelineInfo('active', 3, '2025-08-15', 'rep-priya', 'A2', '2025-02-01', '2026-05-15', 'Expanding into concentrates'),
  paymentReliability: 'excellent',
  preferredPaymentMethod: 'ach',
...
const summitCannabis: Account = {
  ...
  pipeline: makePipelineInfo('active', 3, '2025-12-15', 'rep-jake', 'A2', '2025-07-01', '2026-06-15', 'VMI enrolled, steady growth'),
  paymentReliability: 'excellent',
  preferredPaymentMethod: 'ach',
...
const rainierRemedies: Account = {
  ...
  vmiEnrolled: false,
  status: 'active',
  segments: ['premium', 'multi-category'],
  createdAt: '2024-08-01',
  lastOrderDate: '2026-03-02',
  totalRevenue: 112600,
  thirtyDayRevenue: 9800,
  avgOrderValue: 2100,
  orderCount: 54,
  pipelineStatus: 'active',
  pipelinePhase: 4,
  pipelineHistory: [
    ...
    { from: { status: 'active', phase: 3 }, to: { status: 'active', phase: 4 }, date: '2025-11-01', trigger: 'Deep relationship, broad category mix, reliable payment' },
  ],
  pipeline: makePipelineInfo('active', 4, '2025-11-01', 'rep-priya', 'A3', '2025-03-01', '2026-05-01'),
  paymentReliability: 'good',
  preferredPaymentMethod: 'cod',
...
const olympicGreens: Account = {
  ...
  pipelineHistory: [
    ...
    { from: { status: 'active', phase: 2 }, to: { status: 'active', phase: 3 }, date: '2025-11-01', trigger: '3+ categories, growing AOV, reliable payment' },
  ],
  pipeline: makePipelineInfo('active', 3, '2025-11-01', 'rep-priya', 'A2', '2025-04-01', '2026-05-01'),
  paymentReliability: 'excellent',
  preferredPaymentMethod: 'ach',
...
const spokaneValley: Account = {
  ...
  pipeline: makePipelineInfo('active', 2, '2025-08-01', 'rep-carlos', 'A1', '2025-02-10', '2026-05-01'),
  paymentReliability: 'good',
  preferredPaymentMethod: 'cod',
...
const capitolHillCollective: Account = {
  ...
  pipelineHistory: [
    ...
    { from: { status: 'active', phase: 2 }, to: { status: 'active', phase: 3 }, date: '2025-06-01', trigger: 'Consistent high-value ordering across 5 categories' },
    { from: { status: 'active', phase: 3 }, to: { status: 'active', phase: 4 }, date: '2025-12-01', trigger: 'Deep relationship, broad mix, strong sell-through' },
  ],
  pipeline: makePipelineInfo('active', 4, '2025-12-01', 'rep-jake', 'A3', '2025-06-01', '2026-06-01', 'Trend-setter — concentrate and vape specialist'),
  paymentReliability: 'excellent',
  preferredPaymentMethod: 'ach',
...
const harborCannabis: Account = {
  ...
  vmiEnrolled: false,
  status: 'active',
  segments: ['rural', 'flower-focused', 'recovered'],
  createdAt: '2025-06-01',
  lastOrderDate: '2026-03-03',
  totalRevenue: 24800,
  thirtyDayRevenue: 4800,
  avgOrderValue: 2480,
  orderCount: 10,
  pipelineStatus: 'active',
  pipelinePhase: 2,
  pipelineHistory: [
    { from: { status: 'active', phase: 1 }, to: { status: 'active', phase: 2 }, date: '2025-09-01', trigger: 'Monthly ordering cadence established' },
    { from: { status: 'active', phase: 2 }, to: { status: 'inactive', phase: 1 }, date: '2025-12-01', trigger: 'Order frequency dropped sharply' },
    { from: { status: 'inactive', phase: 1 }, to: { status: 'recovery', phase: 1 }, date: '2026-01-15', trigger: 'Rep outreach successful — Earl agreed to trial order' },
    { from: { status: 'recovery', phase: 1 }, to: { status: 'active', phase: 2 }, date: '2026-03-01', trigger: 'Recovered — consistent ordering resumed' },
  ],
  pipeline: makePipelineInfo('active', 2, '2026-03-01', 'rep-carlos', 'R1', '2026-01-15', '2026-06-01', 'Recently recovered — monitor closely'),
  paymentReliability: 'fair',
...
const evergreenWellness: Account = {
  ...
  pipelinePhase: 2,
  pipelineHistory: [
    { from: { status: 'active', phase: 1 }, to: { status: 'active', phase: 2 }, date: '2025-11-01', trigger: 'Regular ordering cadence established' },
    ...
    { from: { status: 'recovery', phase: 1 }, to: { status: 'active', phase: 2 }, date: '2026-02-15', trigger: 'Recovered — ordering resumed with expanded categories' },
  ],
  pipeline: makePipelineInfo('active', 2, '2026-02-15', 'rep-carlos', 'R1', '2025-12-15', '2026-05-15', 'Recovered — expanding into edibles'),
  paymentReliability: 'good',
  preferredPaymentMethod: 'cod',
...
const generatedAccounts: Account[] = [
  makeAccount('acct-001', 'Ballard Buds', 'Ballard Buds LLC', 'WA-CCB-420301', '5412 Ballard Ave NW', 'Seattle', '98107', 47.6687, -122.3855, 'Seattle Metro', 'rep-jake', 88, 'stable', 'active', true, 312400, 28600, 3200, 98, 'excellent', 'ach', ['high-volume', 'vmi'], '2026-03-05', 'Jen Takahashi', 'buyer', '(206) 555-0301', 'jen@ballardbuds.com', '2024-07-15',
    'active', 1, [
      { from: { status: 'active', phase: 1 }, to: { status: 'active', phase: 1 }, date: '2025-11-01', trigger: 'Account created — ordering started' },
    ],
    makePipelineInfo('active', 1, '2025-11-01', 'rep-jake', undefined, undefined, '2026-05-01')),
  makeAccount('acct-002', 'Capitol Hill Green', 'CHG Cannabis Inc', 'WA-CCB-420302', '1020 E Pike St', 'Seattle', '98122', 47.6144, -122.3197, 'Seattle Metro', 'rep-jake', 76, 'stable', 'active', false, 186900, 16400, 2600, 72, 'good', 'cod', ['mid-tier'], '2026-03-01', 'Marcus Bell', 'buyer', '(206) 555-0302', 'marcus@capitolhillgreen.com', '2024-08-22',
    ...
    makePipelineInfo('active', 2, '2025-03-01', 'rep-jake', 'A1', '2024-08-22', '2026-06-01')),
  makeAccount('acct-003', 'Fremont Flowers', 'Fremont Cannabis Co', 'WA-CCB-420303', '3501 Fremont Pl N', 'Seattle', '98103', 47.6512, -122.3506, 'Seattle Metro', 'rep-jake', 81, 'improving', 'prospect', false, 0, 0, 0, 0, 'good', 'ach', ['premium'], null, 'Olivia Grant', 'buyer', '(206) 555-0303', 'olivia@fremontflowers.com', '2024-09-10',
    'inactive', 3, [
      { from: { status: 'inactive', phase: 1 }, to: { status: 'inactive', phase: 2 }, date: '2025-06-01', trigger: 'Initial outreach made — they know who we are' },
      { from: { status: 'inactive', phase: 2 }, to: { status: 'inactive', phase: 3 }, date: '2025-10-15', trigger: 'Meeting happened — active dialogue established' },
    ],
    makePipelineInfo('inactive', 3, '2025-10-15', 'rep-jake', 'I2', '2025-06-01', '2026-04-15', 'Engaged — meeting scheduled for product pitch')),
  makeAccount('acct-004', 'Bellevue Botanicals', 'BB Wellness LLC', 'WA-CCB-420304', '890 Bellevue Way NE', 'Bellevue', '98004', 47.6153, -122.2026, 'Eastside', 'rep-priya', 91, 'stable', 'prospect', false, 0, 0, 0, 0, 'excellent', 'ach', ['premium', 'vmi'], null, 'Rachel Nguyen', 'buyer', '(425) 555-0304', 'rachel@bellevuebotanicals.com', '2024-05-20',
    'inactive', 3, [
      { from: { status: 'inactive', phase: 1 }, to: { status: 'inactive', phase: 2 }, date: '2025-04-01', trigger: 'Contacted via email intro' },
      { from: { status: 'inactive', phase: 2 }, to: { status: 'inactive', phase: 3 }, date: '2025-09-15', trigger: 'Store visit scheduled, product catalog reviewed' },
    ],
    makePipelineInfo('inactive', 3, '2025-09-15', 'rep-priya', 'I2', '2025-04-01', '2026-04-01', 'Interested in premium VMI program')),
  makeAccount('acct-005', 'Kirkland Kush', 'KK Enterprises', 'WA-CCB-420305', '12030 NE 85th St', 'Kirkland', '98033', 47.6808, -122.1965, 'Eastside', 'rep-priya', 64, 'declining', 'prospect', false, 98700, 5600, 1800, 55, 'fair', 'cod', ['mid-tier', 'at-risk'], '2026-02-15', 'Steve Park', 'manager', '(425) 555-0305', 'steve@kirklandkush.com', '2025-01-10',
    'inactive', 5, [
      { from: { status: 'inactive', phase: 1 }, to: { status: 'inactive', phase: 2 }, date: '2025-06-01', trigger: 'Cold outreach via email' },
      { from: { status: 'inactive', phase: 2 }, to: { status: 'inactive', phase: 3 }, date: '2025-09-15', trigger: 'Meeting with Steve, interested in flower line' },
      { from: { status: 'inactive', phase: 3 }, to: { status: 'inactive', phase: 4 }, date: '2025-12-01', trigger: 'Sample pack sent — flower and preroll' },
      { from: { status: 'inactive', phase: 4 }, to: { status: 'inactive', phase: 5 }, date: '2026-02-15', trigger: 'First order placed — converting' },
    ],
    makePipelineInfo('inactive', 5, '2026-02-15', 'rep-priya', 'I4', '2025-12-01', '2026-04-15', 'First order placed, not yet regular buyer')),
  makeAccount('acct-006', 'Redmond Relief', 'Redmond Relief Dispensary', 'WA-CCB-420306', '16420 Redmond Way', 'Redmond', '98052', 47.6740, -122.1215, 'Eastside', 'rep-priya', 73, 'stable', 'prospect', false, 0, 0, 0, 0, 'good', 'cod', ['mid-tier'], null, 'Karen Osei', 'buyer', '(425) 555-0306', 'karen@redmondrelief.com', '2024-11-05',
    'inactive', 2, [
      { from: { status: 'inactive', phase: 1 }, to: { status: 'inactive', phase: 2 }, date: '2025-11-05', trigger: 'Initial email outreach — they know who we are' },
    ],
    makePipelineInfo('inactive', 2, '2025-11-05', 'rep-priya', 'I1', '2024-11-05', '2026-04-05')),
  makeAccount('acct-007', 'Tacoma Treehouse', 'Treehouse Cannabis LLC', 'WA-CCB-420307', '2714 6th Ave', 'Tacoma', '98406', 47.2570, -122.4647, 'Tacoma', 'rep-priya', 69, 'stable', 'at-risk', false, 118400, 10200, 2050, 58, 'good', 'cod', ['mid-tier'], '2026-03-01', 'Derek Johnson', 'buyer', '(253) 555-0307', 'derek@tacomaTreehouse.com', '2025-02-14',
    'recovery', 1, [
      { from: { status: 'active', phase: 2 }, to: { status: 'active', phase: 3 }, date: '2025-06-01', trigger: 'Regular ordering established' },
      { from: { status: 'active', phase: 3 }, to: { status: 'recovery', phase: 1 }, date: '2026-02-01', trigger: 'Order frequency dropped — competitor opened nearby' },
    ],
    makePipelineInfo('recovery', 1, '2026-02-01', 'rep-priya', 'A3', '2025-06-01', '2026-04-01', 'Early warning — competitor opened nearby store')),
  makeAccount('acct-008', 'Olympia Organics', 'Olympia Organics Corp', 'WA-CCB-420308', '522 4th Ave E', 'Olympia', '98501', 47.0462, -122.8966, 'Olympia', 'rep-priya', 82, 'improving', 'active', false, 167200, 15800, 2800, 60, 'excellent', 'ach', ['premium', 'organic'], '2026-03-03', 'Megan Fox', 'owner', '(360) 555-0308', 'megan@olympiaorganics.com', '2024-10-01',
    'active', 3, [
      { from: { status: 'active', phase: 1 }, to: { status: 'active', phase: 2 }, date: '2025-02-01', trigger: 'Regular monthly ordering established' },
      { from: { status: 'active', phase: 2 }, to: { status: 'inactive', phase: 1 }, date: '2025-04-01', trigger: 'Ownership transition — orders paused' },
      { from: { status: 'inactive', phase: 1 }, to: { status: 'recovery', phase: 1 }, date: '2025-06-15', trigger: 'New owner re-engaged with trial order' },
      { from: { status: 'recovery', phase: 1 }, to: { status: 'active', phase: 3 }, date: '2025-12-01', trigger: 'Exceeded pre-lapse levels — graduated to Growing' },
    ],
    makePipelineInfo('active', 3, '2025-12-01', 'rep-priya', 'R1', '2025-06-15', '2026-06-01', 'Recovered from ownership transition — now growing')),
  makeAccount('acct-009', 'Spokane Smoke Shop', 'SSS Holdings', 'WA-CCB-420309', '2104 N Monroe St', 'Spokane', '99205', 47.6728, -117.4281, 'Spokane', 'rep-carlos', 55, 'declining', 'at-risk', false, 67400, 3800, 1500, 45, 'fair', 'cod', ['budget', 'at-risk'], '2026-02-10', 'Tyler Reed', 'buyer', '(509) 555-0309', 'tyler@spokanesmoke.com', '2025-03-20',
    ...
    makePipelineInfo('inactive', 2, '2026-02-15', 'rep-carlos', 'I1', '2026-01-15', '2026-05-15', 'Outreach attempted — awaiting response')),
  makeAccount('acct-010', 'Walla Walla Weed Co', 'WW Cannabis LLC', 'WA-CCB-420310', '15 E Main St', 'Walla Walla', '99362', 46.0646, -118.3387, 'Eastern WA', 'rep-carlos', 62, 'stable', 'active', false, 54200, 4600, 1700, 32, 'good', 'mail', ['rural'], '2026-02-20', 'Amy Collins', 'buyer', '(509) 555-0310', 'amy@wallawallaweed.com', '2025-04-15',
    ...
    makePipelineInfo('active', 1, '2025-04-15', 'rep-carlos', undefined, undefined, '2026-04-15')),
  makeAccount('acct-011', 'Yakima Valley Green', 'YVG Dispensary', 'WA-CCB-420311', '110 S 2nd St', 'Yakima', '98901', 46.6021, -120.5059, 'Eastern WA', 'rep-carlos', 71, 'improving', 'active', false, 78900, 7200, 1950, 41, 'good', 'cod', ['mid-tier'], '2026-03-01', 'Roberto Silva', 'buyer', '(509) 555-0311', 'roberto@yvgreen.com', '2025-05-01',
    ...
    makePipelineInfo('recovery', 2, '2026-01-15', 'rep-carlos', 'R1', '2025-11-15', '2026-04-15', 'Confirmed competitive displacement — investigating root cause')),
  makeAccount('acct-012', 'Bellingham Bloom', 'BB Cannabis Co', 'WA-CCB-420312', '1298 Railroad Ave', 'Bellingham', '98225', 48.7519, -122.4787, 'NW Washington', 'rep-jake', 77, 'stable', 'active', false, 134500, 11400, 2400, 56, 'good', 'ach', ['mid-tier'], '2026-03-02', 'Claire Dawson', 'buyer', '(360) 555-0312', 'claire@bellinghambloom.com', '2024-12-01',
    ...
    makePipelineInfo('active', 2, '2025-04-01', 'rep-jake', 'A1', '2024-12-01', '2026-04-01')),
  makeAccount('acct-013', 'Vancouver Vapor', 'VV Holdings', 'WA-CCB-420313', '1600 Main St', 'Vancouver', '98660', 45.6387, -122.6615, 'SW Washington', 'rep-priya', 44, 'declining', 'prospect', false, 0, 0, 0, 0, 'poor', 'cod', ['budget', 'at-risk'], null, 'Nina Walsh', 'buyer', '(360) 555-0313', 'nina@vancouvervapor.com', '2025-06-15',
    'inactive', 2, [
      { from: { status: 'inactive', phase: 1 }, to: { status: 'inactive', phase: 2 }, date: '2025-08-15', trigger: 'Initial outreach made — cold call' },
    ],
    makePipelineInfo('inactive', 2, '2025-08-15', 'rep-priya', 'I1', '2025-06-15', '2026-04-15', 'Budget segment — low engagement so far')),
  makeAccount('acct-014', 'Tri-Cities Terpenes', 'TCT Cannabis', 'WA-CCB-420314', '234 George Washington Way', 'Richland', '99352', 46.2804, -119.2752, 'Eastern WA', 'rep-carlos', 66, 'stable', 'prospect', false, 0, 0, 0, 0, 'good', 'mail', ['mid-tier'], null, 'Jason Briggs', 'buyer', '(509) 555-0314', 'jason@tricitiesterp.com', '2025-01-20',
    'inactive', 4, [
      { from: { status: 'inactive', phase: 1 }, to: { status: 'inactive', phase: 2 }, date: '2025-05-01', trigger: 'Contacted via trade show intro' },
      { from: { status: 'inactive', phase: 2 }, to: { status: 'inactive', phase: 3 }, date: '2025-09-01', trigger: 'Store visit and product review' },
      { from: { status: 'inactive', phase: 3 }, to: { status: 'inactive', phase: 4 }, date: '2026-01-15', trigger: 'Sample pack sent — terpene-focused flower and concentrates' },
    ],
    makePipelineInfo('inactive', 4, '2026-01-15', 'rep-carlos', 'I3', '2025-09-01', '2026-04-15', 'Samples sent — awaiting feedback')),
  makeAccount('acct-015', 'Everett Extracts', 'EE Dispensary LLC', 'WA-CCB-420315', '2930 Colby Ave', 'Everett', '98201', 47.9790, -122.2021, 'North Sound', 'rep-jake', 79, 'improving', 'active', false, 156800, 14200, 2700, 58, 'good', 'ach', ['premium'], '2026-03-03', 'Hannah Lee', 'buyer', '(425) 555-0315', 'hannah@everettextracts.com', '2024-08-10',
    'active', 2, [
      { from: { status: 'active', phase: 1 }, to: { status: 'active', phase: 2 }, date: '2025-01-15', trigger: 'Regular biweekly ordering established' },
      { from: { status: 'active', phase: 2 }, to: { status: 'inactive', phase: 1 }, date: '2025-08-01', trigger: 'Lost shelf space to competitor' },
      { from: { status: 'inactive', phase: 1 }, to: { status: 'recovery', phase: 1 }, date: '2025-09-15', trigger: 'Jake negotiated exclusive extract placement' },
      { from: { status: 'recovery', phase: 1 }, to: { status: 'active', phase: 2 }, date: '2026-01-15', trigger: 'Recovered — regular ordering resumed' },
    ],
    makePipelineInfo('active', 2, '2026-01-15', 'rep-jake', 'R1', '2025-09-15', '2026-04-15', 'Recovered — extract specialist')),
  makeAccount('acct-016', 'Bainbridge Botanics', 'Bainbridge Cannabis', 'WA-CCB-420316', '180 Winslow Way E', 'Bainbridge Island', '98110', 47.6265, -122.5091, 'Kitsap', 'rep-jake', 83, 'stable', 'active', false, 92100, 8400, 3070, 30, 'excellent', 'ach', ['boutique', 'premium'], '2026-03-02', 'Will Thornton', 'owner', '(206) 555-0316', 'will@bainbridgebotanics.com', '2025-03-01',
    'active', 2, [
      { from: { status: 'active', phase: 1 }, to: { status: 'active', phase: 2 }, date: '2025-07-01', trigger: 'Premium boutique — steady monthly ordering' },
    ],
    makePipelineInfo('active', 2, '2025-07-01', 'rep-jake', 'A1', '2025-03-01', '2026-04-01', 'Boutique premium account')),
  makeAccount('acct-017', 'Cedar Falls Cannabis', 'Cedar Falls LLC', 'WA-CCB-420317', '8120 Railroad Ave SE', 'Snoqualmie', '98065', 47.5287, -121.8253, 'Eastside', 'rep-priya', 0, 'stable', 'inactive', false, 0, 0, 0, 0, 'good', 'cod', ['prospect'], null, 'Unknown', 'other', '(425) 555-0317', 'info@cedarfallscannabis.com', '2026-03-01',
    'inactive', 1, [],
    makePipelineInfo('inactive', 1, '2026-03-01', 'rep-priya', undefined, undefined, '2026-06-01', 'Name on license list — no interaction yet')),
  makeAccount('acct-018', 'Leavenworth Leaf', 'Leavenworth Leaf LLC', 'WA-CCB-420318', '820 Front St', 'Leavenworth', '98826', 47.5962, -120.6615, 'Eastern WA', 'rep-carlos', 0, 'stable', 'inactive', false, 0, 0, 0, 0, 'good', 'cod', ['prospect'], null, 'Unknown', 'other', '(509) 555-0318', 'info@leavenworthleaf.com', '2026-02-15',
    'inactive', 1, [],
    makePipelineInfo('inactive', 1, '2026-02-15', 'rep-carlos', undefined, undefined, '2026-05-15', 'Rural market — identified via license database')),
  makeAccount('acct-019', 'Port Townsend Provisions', 'PTP Cannabis LLC', 'WA-CCB-420319', '234 Water St', 'Port Townsend', '98368', 48.1170, -122.7604, 'NW Washington', 'rep-jake', 0, 'stable', 'inactive', false, 0, 0, 0, 0, 'good', 'cod', ['prospect'], null, 'Unknown', 'other', '(360) 555-0319', 'info@pttownprovisions.com', '2026-01-20',
    'inactive', 1, [],
    makePipelineInfo('inactive', 1, '2026-01-20', 'rep-jake', undefined, undefined, '2026-04-20', 'Boutique market potential — no outreach yet')),
  makeAccount('acct-020', 'Moses Lake Green', 'MLG Dispensary Inc', 'WA-CCB-420320', '324 W Broadway Ave', 'Moses Lake', '98837', 47.1301, -119.2781, 'Eastern WA', 'rep-carlos', 0, 'stable', 'inactive', false, 0, 0, 0, 0, 'good', 'cod', ['prospect'], null, 'Unknown', 'other', '(509) 555-0320', 'info@moseslakegreen.com', '2026-02-01',
    'inactive', 1, [],
    makePipelineInfo('inactive', 1, '2026-02-01', 'rep-carlos', undefined, undefined, '2026-05-01', 'High-traffic I-90 corridor location')),
];
...
const pipelineDistribution: PipelineDistribution[] = [
  { phase: 1, phaseLabel: 'Phase 1', active: 2, inactive: 4, recovery: 1 },
  { phase: 2, phaseLabel: 'Phase 2', active: 7, inactive: 3, recovery: 1 },
  { phase: 3, phaseLabel: 'Phase 3', active: 5, inactive: 2, recovery: 0 },
  { phase: 4, phaseLabel: 'Phase 4', active: 3, inactive: 1, recovery: 0 },
  { phase: 5, phaseLabel: 'Phase 5', active: 2, inactive: 1, recovery: 0 },
];

// --- Recovery Funnel ---

const recoveryFunnel: RecoveryFunnel[] = [
  { phase: 'R1 Signal Detected', count: 1, conversionRate: 100 },
  { phase: 'R2 Confirmed Decline', count: 1, conversionRate: 50 },
  { phase: 'R3 Active Recovery', count: 0, conversionRate: 0 },
  { phase: 'R4 Re-engaging', count: 0, conversionRate: 0 },
  { phase: 'R5 Recovered', count: 0, conversionRate: 0 },
];
