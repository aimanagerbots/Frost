...
export function DriverCards({ drivers, loading }: DriverCardsProps) {
  ...
  return (
    <div className="space-y-3">
      <h3 className="text-sm font-medium text-muted">Drivers</h3>
          ...
          <div key={driver.id} className="rounded-xl border border-default bg-card p-4">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-default">{driver.name}</h4>
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <p className="text-default font-medium">{driver.deliveriesToday} deliveries</p>
              </div>
              <div>
                <span className="text-muted text-xs">On-Time</span>
                <p className="text-default font-medium">{driver.onTimeRate}%</p>
              </div>
            </div>

            <div className="mt-3 pt-3 border-t border-default flex items-center gap-1.5 text-xs text-muted">
