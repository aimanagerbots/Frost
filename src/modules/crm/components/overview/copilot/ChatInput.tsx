    ...
    <div className="border-t border-default bg-card p-4">
      <div className="flex items-end gap-2">
        ...
        <button
          ...
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#F59E0B] text-black transition-colors hover:bg-[#F59E0B]/90 disabled:opacity-40 disabled:cursor-not-allowed"
        >
