...
const calendarEvents: CalendarEvent[] = [
  ...
  // --- Meeting Events (8) ---
  { id: 'cal-meet-1', title: 'Sales Team Standup', type: 'meeting', date: getDateOffset(0), startTime: '09:00', endTime: '09:30', allDay: false, module: 'Meetings', moduleRoute: '/meetings', color: EVENT_COLORS.meeting, description: 'Daily sync — pipeline review', attendees: ['Jake Morrison', 'Priya Sharma', 'Carlos Ruiz', 'Dana Kim'] },
  ...
  { id: 'cal-meet-4', title: 'Sales Team Standup', type: 'meeting', date: getDateOffset(1), startTime: '09:00', endTime: '09:30', allDay: false, module: 'Meetings', moduleRoute: '/meetings', color: EVENT_COLORS.meeting, attendees: ['Jake Morrison', 'Priya Sharma', 'Carlos Ruiz', 'Dana Kim'] },
  ...
  { id: 'cal-meet-7', title: 'Sales Call: Pacific Leaf', type: 'meeting', date: getDateOffset(3), startTime: '11:00', endTime: '11:45', allDay: false, module: 'CRM', moduleRoute: '/crm', color: EVENT_COLORS.meeting, description: 'Follow-up on lost vape placement', attendees: ['Priya Sharma'] },
  ...
  { id: 'cal-vd-2', title: 'Vendor Day: Summit Collective', type: 'vendor-day', date: getDateOffset(5), startTime: '11:00', endTime: '17:00', allDay: false, module: 'CRM', moduleRoute: '/crm', color: EVENT_COLORS['vendor-day'], description: 'Budtender education + new product intro. Rep: Priya Sharma', attendees: ['Priya Sharma'] },
  ...
  { id: 'cal-vd-4', title: 'Vendor Day: Emerald City Cannabis', type: 'vendor-day', date: getDateOffset(12), startTime: '11:00', endTime: '15:00', allDay: false, module: 'CRM', moduleRoute: '/crm', color: EVENT_COLORS['vendor-day'], description: 'New account introduction. Rep: Dana Kim', attendees: ['Dana Kim'] },
  { id: 'cal-vd-5', title: 'Vendor Day: Pacific Leaf', type: 'vendor-day', date: getDateOffset(17), startTime: '10:00', endTime: '16:00', allDay: false, module: 'CRM', moduleRoute: '/crm', color: EVENT_COLORS['vendor-day'], description: 'Win-back visit — lost vape placement. Rep: Priya Sharma', attendees: ['Priya Sharma'] },
